...
def remove_nils_and_false_from_array(array)
  array.compact.select { | n | n != false }
end
...
def number_of_elements_that_are_palindromes(array)
  array.select { | n | n if n == n.reverse }.length
end

# return the shortest word in an array
def shortest_word_in_array(array)
  array.sort_by { | x | x.length }[0]
end
...
def get_all_letters_in_array_of_words(array)
  array.map { | x | x.each_char.sort}.flatten.sort
end
...
def your_birthday_is_on_a_friday_in_the_year(birthday)
  ...
  x = 2013
  require 'date'
  d = Date.parse('1st Jan' + x.to_s)
    while d.strftime('%A') != "Friday"
      x = x + 1
      d = Date.parse(birthday + x.to_s)
      if d.strftime('%A') == "Friday"
        puts "Your next birthday on a " + d.strftime('%A') + " will be in " + x.to_s + "."
    end
  end
end
...
def fizzbuzz_without_modulo
  i = 1
  while i < 101
    if (i/15.round(2)).to_s[-1,1] == "0"
      print "fizzbuzz" + "\n"
    elsif (i/3.round(2)).to_s[-1,1] == "0"
      print "fizz" + "\n"
    elsif (i/5.round(2)).to_s[-1,1] == "0"
      print "buzz" + "\n"
    else
      print i.to_s + "\n"
    end
...
def bottles_one
  ...
  while i > 0
    if i > 1
      print i.to_s + " bottles of beer on the wall, " + i.to_s + " bottles of beer." + "\n" + "Take one down and pass it around, "
      i = i - 1
      print i.to_s + " bottles of beer on the wall." + "\n" + "\n"
    elsif i == 1
      print i.to_s + " bottle of beer on the wall, " + i.to_s + " bottle of beer." + "\n" + "Take one down and pass it around, no more bottles of beer on the wall."  + "\n" + "\n" + "No more bottles of beer on the wall, no more bottles of beer."  + "\n" + "Go to the store and buy some more, 99 bottles of beer on the wall."
      i = i - 1
    end
  end
end
